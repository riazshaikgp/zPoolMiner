namespace zPoolMiner
{
    ...
    public class Algorithm
    {
        ...
        public Algorithm(MinerBaseType minerBaseType, AlgorithmType cryptominer937ID, string minerName, AlgorithmType secondaryCryptoMiner937ID = AlgorithmType.NONE)
        {
            ...
            this.AlgorithmName = AlgorithmCryptoMiner937Names.GetName(DualCryptoMiner937ID());
        ...
        public bool IsDual()
        {
            return (AlgorithmType.DaggerSia <= DualCryptoMiner937ID() && DualCryptoMiner937ID() <= AlgorithmType.DaggerPascal);
        }
    }
}
